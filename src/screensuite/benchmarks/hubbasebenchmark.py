...
from screensuite.response_generation import AnnotatedContent
...
class HubBaseBenchmark(
    ...
    def _calculate_proportion_missing(
        self, responses: Sequence[AnnotatedContent[Any] | None | AgentRunResult]
    ) -> float:
        """
